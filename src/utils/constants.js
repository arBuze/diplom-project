...
export const cards = [
  ...
  },
  {
    ...
    description: 'Выбрав корпус DEXP DC-202M, вы получите возможность собрать компактный компьютер, который можно использовать дома или в офисе. Возможность монтажа видеоадаптера с длиной до 300 мм, предусмотренная конструкцией корпуса, будет полезна любителям игр. При этом важно помнить о том, что кулер процессора может иметь высоту не более чем 142 мм. Вентиляторы в базовую комплектацию модели не входят. Если возникнет соответствующая необходимость, вы сможете задействовать один фронтальный вентилятор (120 или 80 мм) и один 80-миллиметровый тыловой вентилятор. Корпус DEXP DC-202M не укомплектован источником питания. Блок питания вы сможете выбрать, исходя из собственных предпочтений и стоящих перед будущим компьютером задач. Форм-фактор совместимых источников питания – ATX.',
  },
  {
    image: image,
    productName: 'Корпус 12-1242 2452 54452 13546 225235 624624523',
